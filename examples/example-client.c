...
answered Aug 6 '15 at 4:43
Ren-Wei Luo
213
	
   	 
	
Compiling on Ubuntu 14.04. I have tried this with libwebsockets 1.6 and I am getting example-client.c:64:61: error: parameter 3 (‘reason’) has incomplete type ... any pointers? – joël Jan 4 at 15:00
1 	 
	
Thanks for your correct :D, libwebsocket 1.6 has changed almost all of the variables' name from libwebsocket_* to lws_*. – Ren-Wei Luo Jan 27 at 7:08
add a comment
up vote
1
down vote
